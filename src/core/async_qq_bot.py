...
class AsyncQQBotManager:
    ...
    def __init__(self, host: str, port: int, 
        ...
        logger.info(f"异步QQ Bot管理器初始化完成: {self.base_url}")
    ...
    async def handle_group_request(self, group_id: int, user_id: int, 
    ...
    async def kick_group_member(self, group_id: int, user_id: int, 
